...
from .minimalistic_mbtiles_generator_algorithm import MinimalisticMBTilesGeneratorAlgorithm


class MinimalisticMBTilesGeneratorProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(MinimalisticMBTilesGeneratorAlgorithm())
